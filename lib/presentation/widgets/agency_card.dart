...
//   final Agency agency;
//   final VoidCallback? onDelete; // callback to remove from UI

//   const AgencyCard({super.key, required this.agency, this.onDelete});
...
//     // Delete from DB by company title
//     await DBHelper.deleteAgencyByTitle(agency.title);
...
//                         context,
//                         MaterialPageRoute(
//                           builder: (context) => PortfolioAgency(agency: agency),
//                         ),
//                       );
//                     },
